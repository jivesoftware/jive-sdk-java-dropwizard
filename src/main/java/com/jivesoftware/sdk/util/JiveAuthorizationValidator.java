...
public class JiveAuthorizationValidator {
    ...
    private static final WebApplicationException NOT_IMPLEMENTED =
    ...
    public static void authenticate(ContainerRequestContext request) {
        ...
        //TODO:  ACCESS THE INSTANCE DATA STORE AND CONFIRM WE KNOW THIS INSTANCE AND SHOULD BE LISTENING
...
//        } // end try/catch
     ...
     private static String sign(String str, String clientSecret, String algorithm) throws NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException {
    ...
    private static Map<String, String> getParamsFromAuthz(String authHeader) {
