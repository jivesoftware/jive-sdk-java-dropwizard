...
import com.jivesoftware.sdk.client.jersey.filters.DebugClientResponseFilter;
import com.jivesoftware.sdk.client.jersey.filters.StripAllowIllegalResourceCallFilter;
...
public class BaseJiveClient {
    ...
    protected Client buildClient() {
        ...
        //TODO:  ADD IN THE CUSTOM PROPERTY HANDLER FOR UNDERSCORE NAMES
        //see: http://blog.usul.org/jongo-custom-mapper-keys/
        builder.register(StripAllowIllegalResourceCallFilter.class);

        if (log.isDebugEnabled()) {
            builder.register(DebugClientResponseFilter.class);
        } // end if

        //TODO:  IS THIS DONE BY DEFAULT NOW???
