 ...
 */
public class JiveActivity implements Serializable {

    private JiveActor actor;
    private String content;
    
    private JiveActivityDetails jive;
    ...
    public JiveActivityDetails getJive() {
        return jive;
    }

    public void setJive(JiveActivityDetails jive) {
        this.jive = jive;
    }
